...
<body>
    ...
    <div class="HotelGangnamLunaPoon" style="width: 997px; height: 100px; left: 221px; top: 198px; position: absolute; text-align: center; color: #E6E6E6; font-size: 64px; font-family: Antic Didone; font-weight: 400; word-wrap: break-word">STANDARD</div>
            ...
            <div class="col">
                <from action="" method="GET">
                    <div class="input-group mb-3">
                        <input type="text" name="search" value="" class="form-control" placeholder="ค้นหาเลขห้องที่ต้องการ">
                    ...
                    <table class="table table-hover text-center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="delete_room.php?id=<?= $row["room_num"] ?>" class="btn btn-outline-danger">
    ...
    <!-- <div class="container" style="width: 2000px; height: 44.05px; left: 180px; top: 420px; position: absolute;">
            <from action="" method="GET">
                <div class="input-group mb-3">
                    <select id="building_id" name="building_id" required>
                        <option value="">-Status-</option>
                        <?php foreach ($result as $results) { ?>
                            <option value="<?php echo $results["status"]; ?>">
