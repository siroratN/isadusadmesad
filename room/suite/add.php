...
<head>
    ...
    <link rel="stylesheet" href="addsuite.css">
    ...
    <form action="adddata.php" method='POST'>
        <div class="all">
            <div class="Group61" style="width: 539px; height: 1206px; left: 0px; top: 0px; position: absolute">
                <div class="Rectangle13" style="width: 539px; height: 1007px; background: rgba(255, 255, 255, 0.75); border-radius: 40px"></div>
                <div class="floor">
                    <div class="textfloor">ชั้น</div>
                    <input class="inputfloor" type="text" id="" name="floor"></input>
                </div>
                <div class="AddStandardRoom" style="width: 319px; height: 30px; left: 190px; top: 44.20px; position: absolute; color: black; font-size: 21px; font-family: Roboto; font-weight: 400; word-wrap: break-word">ADD SUITE ROOM</div>
                <div class="number">
