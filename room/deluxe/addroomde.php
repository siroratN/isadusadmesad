    ...
    <form action="adddata.php" method='POST'>
        <div class="all">
            <div class="Group61" style="width: 539px; height: 1206px; left: 0px; top: 0px; position: absolute">
                ...
                <div class="AddStandardRoom" style="width: 319px; height: 30px; left: 170px; top: 44.20px; position: absolute; color: black; font-size: 21px; font-family: Roboto; font-weight: 400; word-wrap: break-word">ADD DELUXE ROOM</div>
                <div class="number">
