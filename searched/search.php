    ...
    <form action="searched.php" method='POST'>
        <div class="search-bar" style="width: 1405px; height: 140px; background: rgb(216, 217, 226); box-shadow: 20px 20px 120px 15px rgba(0, 0, 0, 0.05); border-radius: 20px">
            <div>
                ...
                <select name="type" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" style="width: 415px; height: 51px; border-radius: 20px; font-size: 14px; padding: 16px;" required>
            ...
            <div class="check-in date">
                ...
                <div class='input-group date' id='picker1'>
                    ...
                    <input type="text" name="check_in" class="form-control rounded-3xl"  placeholder="ex 01/01/2023" style="height: 50px; width: 228;border-top-left-radius:20px;border-bottom-left-radius:20px ;"></input>
            ...
            <div class="check-out date">
                ...
                <div class='input-group date' id='picker2'>
                    <input type='text' class="form-control" name="check_out" placeholder="ex 05/01/2023" style="height: 50px; width: 228;border-top-left-radius:20px;border-bottom-left-radius:20px ;" />
                    <span class="input-group-addon" style="border-top-right-radius: 20px;border-bottom-right-radius: 20px;">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
