...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">     <title>Document</title>
<body>
    ...
    <div class="HotelGangnamLunaPoon" style="width: 997px; height: 100px; left: 221px; top: 198px; position: absolute; text-align: center; color: #E6E6E6; font-size: 64px; font-family: Antic Didone; font-weight: 400; word-wrap: break-word">Hotel gangnam luna poon</div>
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="#?id=<?= $row["booking_id"] ?>" class="btn btn-outline-info">
                                <i class="bi bi-info-circle"></i></a></td>
                                <td><a href="#?id=<?= $row["booking_id"] ?>" class="btn btn-outline-danger">
