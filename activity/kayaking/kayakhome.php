...
<div class="Desktop14" style="width: 1440px; height: 1024px; position: relative;">
  ...
  <div>
    <div class="Desktop15" style="width: 1440px; height: 1024px; position: relative; background: white">
        <div class="Kayaking" style="width: 889px; height: 101px; left: 275px; top: 133px; position: absolute; text-align: center; color: #FFC700; font-size: 80px; font-family: Bayon; font-weight: 400; line-height: 24px; word-wrap: break-word">KAYAKING</div>
        <img class="Pngwing3" style="width: 332px; height: 184px; left: 109px; top: 61px; position: absolute" src="pngwing.com(2).png" />
        <img class="Pngwing4" style="width: 266px; height: 266px; left: 991px; top: 0px; position: absolute" src="pngwing.com(3).png" />
    </div>
    <div class="container" style="width: 2000px; height: 44.05px; left: 170px; top: 300px; position: absolute;">
        <div class="row mt-5">
            <div class="col">
