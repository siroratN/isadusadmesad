...
$query = "SELECT *
              from rooms
              JOIN type_room
              ON type_room.type_id = rooms.type_id
              WHERE room_num = '$rm'
              ";
...
<body>
  ...
  <?php
    ...
    <div class="Room">
      ...
      <div class="Typeroom"><?php echo $row['room_num'] ?></div>
      <div class="Roomdetail">

        <div class="Alldetail"><?php echo $row['detail'] ?></div>
      ...
      <div class="Emojidetail">
        <div class="Bedsize"><?php echo $row['max_guests'] ?> King size bed</div>
        <div class="Guests">up to <?php echo $row['max_guests'] ?> GUESTS</div>
